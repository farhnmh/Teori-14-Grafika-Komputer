...
int main() {
	...
	int image_width = 0;
	int image_height = 0;
	unsigned char* image = SOIL_load_image("Images/gumball.png", &image_width, &image_height, NULL, SOIL_LOAD_RGBA);
	...
	int image_width1 = 0;
	int image_height1 = 0;
	unsigned char* image1 = SOIL_load_image("Images/sand.png", &image_width1, &image_height1, NULL, SOIL_LOAD_RGBA);
